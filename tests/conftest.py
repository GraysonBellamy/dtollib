...
and trio. Matches the backend matrix used by the sibling ``alicatlib``,
``sartoriuslib``, and ``nidaqlib`` packages and catches regressions that
only surface under one scheduler.
"""
